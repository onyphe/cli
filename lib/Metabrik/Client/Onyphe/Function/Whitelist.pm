...
# | whitelist /tmp/domain.csv
#
# echo ip > /tmp/ip.csv
# echo '13.208.0.0/16' >> /tmp/ip.csv
# | whitelist /tmp/domain.csv cidr=ip'
#
sub process {
   my $self = shift;
   ...
   for my $field (@$csv_header) {
      ...
      # Fetch the value from current flat:
...
Metabrik::Client::Onyphe::Function::Whitelist - client::onyphe::function::whitelist Brik
